*DECK LIBDRB
      SUBROUTINE LIBDRB (IPDRL,HNAMIS,NGRO,NL,NDEL,NBESP,ENER,SN,SB,NED,
     1 HVECT,DELTA,LBIN,NFS,BENER,AWR,DELECC,IGECCO,IMPX,NGF,NGFR,LSCAT,
     2 LSIGF,LADD,LGOLD,SIGS,SCAT,TOTAL,ZNPHI,SIGF,CHI,CHI4G,SADD,GOLD,
     3 BIN)
*
*-----------------------------------------------------------------------
*
